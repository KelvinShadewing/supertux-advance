...
bgAurora <- newSprite("res/gfx/bg-aurora.png", 1, 90);
//spriteSetBlendMode(bgAurora, bm_add);
bgSnowMountains <- newSprite("res/gfx/bg-snow-mountain-range.png", 640, 128);
...
bgOceanGray <- newSprite("res/gfx/ocean-gray.png", 480, 8);
...
bgSnowPlain <- newSprite("res/gfx/bg-snow-plain.png", 800, 96);
bgSnowPlain2 <- newSprite("res/gfx/bg-snow-plain-2.png", 400, 48);
